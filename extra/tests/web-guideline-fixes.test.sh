...
assert_contains frontend/src/components/StackList.vue 'aria-label="Compose-Projekte suchen"'
assert_contains frontend/src/components/StackList.vue 'aria-label="Suche leeren"'
assert_contains frontend/src/components/StackList.vue 'name="stack-search"'
assert_contains frontend/src/components/StackList.vue 'aria-label="Stacks suchen"'
...
assert_contains frontend/src/components/Container.vue 'aria-label="Statistiken ein-/ausklappen"'
...
assert_contains frontend/src/pages/DashboardHome.vue 'aria-label="Agentnamen bearbeiten"'
assert_contains frontend/src/pages/DashboardHome.vue 'aria-label="Agent entfernen"'
